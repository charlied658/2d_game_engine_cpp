...
namespace InfoWindow {
    ...
    void imgui() {
        ...
        Editor::SpriteSystem::get_transient_sprite_manager_list(&transient_sprite_manager_list, &transient_sprite_manager_count);
        Editor::PhysicsSystem::get_physics_manager_list(&physics_manager_list,&physics_manager_count);
        Editor::PhysicsSystem::get_transient_physics_manager_list(&transient_physics_manager_list,&transient_physics_manager_count);
        Editor::BehaviorSystem::get_behavior_manager_list(&behavior_manager_list,&behavior_manager_count);
        Editor::BehaviorSystem::get_transient_behavior_manager_list(&transient_behavior_manager_list,&transient_behavior_manager_count);
        ...
        if (ImGui::BeginTabBar("TabBar"))
        {
            ...
            if (ImGui::BeginTabItem("Objects")) {
                ...
                ImGui::Text("Transient sprite managers: %d", transient_sprite_manager_count);
                ImGui::Text("Transient physics managers: %d", transient_physics_manager_count);
                ImGui::Text("Transient behavior managers: %d", transient_behavior_manager_count);
                ImGui::EndTabItem();
            }
