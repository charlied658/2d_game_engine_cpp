...
namespace Editor {
    namespace SpriteBatch {
         ...
         */
        void init(Editor::SpriteBatch::sprite_batch *batch, int max_batch_size, int z_index) {
         ...
         * @param batch Sprite batch
         */
        void render(Editor::SpriteBatch::sprite_batch *batch) {
         ...
         * @param obj Sprite
         */
        void add_sprite(Editor::SpriteBatch::sprite_batch *batch, Editor::SpriteManager::sprite_manager *obj) {
         ...
         */
        bool remove_sprite(Editor::SpriteBatch::sprite_batch *batch, Editor::SpriteManager::sprite_manager *obj) {
         ...
         */
        static void generate_vertex_data(Editor::SpriteBatch::sprite_batch *batch, int index) {
         ...
         * @param batch Sprite batch
         */
        static void generate_element_indices(Editor::SpriteBatch::sprite_batch *batch) {
         ...
         * @return Texture slot
         */
        static int get_texture_slot(Editor::SpriteBatch::sprite_batch *batch, unsigned int texture_ID) {
         ...
         */
        bool contains_texture(Editor::SpriteBatch::sprite_batch *batch, unsigned int texture_ID) {
